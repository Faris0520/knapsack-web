...
Dashboard interaktif untuk memvisualisasikan algoritma **Dynamic Programming** pada permasalahan **0/1 Knapsack**. Tampilan dibuat dengan **HTML/CSS/JavaScript**, sedangkan algoritmanya berjalan di server **Flask (Python)**. Dibuat bersama dengan anggota kelompok 6, sebagai tugas akhir mata kuliah Desain dan Analisis Algoritma
