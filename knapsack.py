def solve_knapsack(items: list[dict], capacity: int) -> dict:
    ...
    # dp[i][w] = nilai maksimum yang bisa dicapai dengan mempertimbangkan i barang pertama dan kapasitas tas sebesar w
    ...
    # Jika nilainya BERBEDA dari baris di atasnya (dp[i-1][w]), berarti barang ke-i ikut diambil.
    selected = []
    w = capacity
